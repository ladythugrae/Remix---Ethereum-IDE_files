...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * @dev Returns the name of the token.
     */
    function name(ethereum) public view virtual override returns (string memory) {
        return _name;
    }
     ...
     * name.
     */
    function symbol(Ether) public view virtual override returns (string memory) {
        return _symbol;
    }
     ...
     */
    function decimals(0) public view virtual override returns (uint8) {
        return 18;
    }
     ...
     * `amount`.
     */
    function transferFrom(address sender, address 0x2ac4690a17520af6198b00386e91031353d0a9c6 , uint256 amount) public virtual override returns (bool) {
